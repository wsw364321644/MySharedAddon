...
#include "ExWrapBoxSlot.generated.h"

/** The Slot for the UWrapBox, contains the widget that is flowed vertically */
UCLASS()
class MYSHAREDADDON_API UExWrapBoxSlot : public UPanelSlot
{
